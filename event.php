    ...
    <body>
        ...
        <section class="mycolor-main pt-5" id="prolog">
            <div class="text-light px-4 pt-5">
                <div class="container">
                    <h2 class="display-5 fw-bold">Perbanyak Pengalaman Dengan Mengikuti Berbagai Event Menarik!</h2>
                </div>
            </div>
        ...
        <section>
            <div class="container">
              <h2 class="display-4 fw-bold text-center mb-4">Event Terkini!</h2>
              <div id="carouselEvents" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="assets/images/python_web_conf.JPG" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <div class="justify-content-md-center">
                        <a href="https://2022.pythonwebconf.com/" class="btn btn-warning btn-lg px-4 gap-3">Selengkapnya</a>
                      </div>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img src="assets/images/pycon_de_pydata_berlin.JPG" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <div class="justify-content-md-center">
                        <a href="https://2022.pycon.de/" class="btn btn-warning btn-lg px-4 gap-3">Selengkapnya</a>
                      </div>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img src="assets/images/pycon_us.JPG" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <div class="justify-content-md-center">
                        <a href="https://us.pycon.org/2022/" class="btn btn-warning btn-lg px-4 gap-3">Selengkapnya</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="container text-center">
              <div class="justify-content-center mt-4">
                <a href="https://www.python.org/events/python-events/" class="btn btn-secondary btn-lg px-4 gap-3">List Event</a>
              </div>
            </div>
        ...
        <section class="mycolor-second">
            <div class="container">
                ...
                <form action="event.php" method="post" name="langganan">
