    ...
    <body>
        ...
        <section class="mycolor-main pt-5" id="prolog">
            <div class="text-light px-4 pt-5">
                <div class="container">
                    <h2 class="display-5 fw-bold">Kalkulator sederhana</h2>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <img src="../assets/images/kalkulator.png" class="img-fluid" alt="Kalkulator">
                <figcaption class="text-center figure-caption">
                    Kalkulator sederhana
                </figcaption>

                <article class="mt-3">
                    <p>Python menyediakan berbagai opsi untuk mengembangkan antarmuka pengguna grafis (GUI). Diantaranya seperti yang tercantum dibawah ini </p>
                    <p>Kali ini kita akan menggunakan Tkinter untuk membuat suatu progam GUI pada Python.</p>
                    <p>Apa itu Tkinter ??</p>
                    <p>Tkinter - Tkinter adalah antarmuka Python ke toolkit Tk GUI yang dikirimkan bersama Python.</p>
                    <p>Fungsi progam kalkulator sederhana ini adalah seperti kalkulator pada umumnya. namun pada progam kalkulator sederhana ini hanya terdapat operator pertambahan, pembagian, pengurangan, dan perkalian.
                        serta terdapat tombol C, yang berfungsi untuk menghapus.</p>
                </article>
        ...
        <section class="mycolor-second">
            <div class="container">
                ...
                <form action="kalkulator.php" method="post" name="langganan">
