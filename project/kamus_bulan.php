    ...
    <body>
        ...
        <section class="mycolor-main pt-5" id="prolog">
            <div class="text-light px-4 pt-5">
                <div class="container">
                    <h2 class="display-5 fw-bold">Kamus Bulan</h2>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <img src="../assets/images/kamus_bulan.png" class="img-fluid" alt="Kamus Bulan">
                <figcaption class="text-center figure-caption">
                    Kamus Bulan
                </figcaption>

                <article class="mt-3">
                    <p>Kamus Bulan adalah salah satu contoh program python sederhana yang menggunakan dictionary. </p>
                    <p>Proyek seperti ini dapat menggunakan dictionary , yang menggunakan listing nama bulan berdasarkan hasil inputan user.</p>
                    <p>Dictionary adalah tipe data pada python yang berfungsi untuk menyimpan kumpulan data/nilai dengan pendekatan “key-value”.</p>
                    <br>
                    <p>Lets try it!</p>
                    <div class="card">
                        <div class="card-header">
                            Source Code Kamus Bulan Pylearn
                        </div>
                        <div class="card-body">
                            <code>
                                <p class="ms-4 my-0">a=int(raw_input(“Masukkan bulan ke: “))</p>
                                <p class="ms-4 my-0">seleksi={1:’januari’, 2:’februari’, 3:’maret’, 4:’april’, 5:’mei’, 6:’Juni’, 
                                    7:’Juli’, 8:’agustus’,9:’September’, 10:’Oktober’, 11:’November’, 12:’Desember’}</p>
                                <p class="ms-4 my-0">print “Bulan ke- “,a,”adalah bulan”,seleksi[a]</p>
                            </code>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            Result Kamus Bulan Pylearn
                        </div>
                        <div class="card-body">
                        <p>Apabila saya menginput angka 5, maka hasil yang keluar adalah bulan Mei .</p>
                        </div>
                    </div>
                </article>
        ...
        <section class="mycolor-second">
            <div class="container">
                ...
                <form action="kamus_bulan.php" method="post" name="langganan">
