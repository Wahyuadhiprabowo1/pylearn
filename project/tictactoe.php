    ...
    <body>
        ...
        <section class="mycolor-main pt-5" id="prolog">
            <div class="text-light px-4 pt-5">
                <div class="container">
                    <h2 class="display-5 fw-bold">Tic Tac Toe</h2>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <img src="../assets/images/tictactoe.png" class="img-fluid" alt="Tic Tac Toe">
                <figcaption class="text-center figure-caption">
                    Tic Tac Toe
                </figcaption>

                <article class="mt-3">
                    <p>Tic Tac Toe adalah gim klasik yang kami yakin Anda semua pasti sudah familiar. Ini adalah permainan yang sederhana dan menyenangkan dan hanya membutuhkan dua pemain. Tujuannya adalah untuk membuat garis horizontal, vertikal, atau diagonal yang tidak terputus dari tiga X atau Os pada kisi 3x3 , dan siapa pun yang melakukannya terlebih dahulu adalah pemenang permainan.</p>
                    <p>Proyek seperti ini dapat menggunakan pustaka pygame Python , yang dilengkapi dengan semua grafik dan audio yang diperlukan untuk Anda mulai membangun sesuatu seperti ini.</p>
                </article>
        ...
        <section class="mycolor-second">
            <div class="container">
                ...
                <form action="tictactoe.php" method="post" name="langganan">
