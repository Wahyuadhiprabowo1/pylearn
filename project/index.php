    ...
    <body>
        ...
        <section class="mycolor-main pt-5" id="prolog">
            <div class="text-light px-4 pt-5">
                <div class="container">
                    <h2 class="display-5 fw-bold">Project-Project Yang Menggunakan Python</h2>
                </div>
            </div>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="kalkulator.php" class="btn btn-warning">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="kamus_bulan.php" class="btn btn-warning">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="pemutar_musik.php" class="btn btn-warning">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="tictactoe.php" class="btn btn-warning">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
