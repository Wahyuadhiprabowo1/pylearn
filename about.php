    ...
    <body>
        ...
        <section class="mycolor-main pt-5" id="prolog">
            <div class="text-light pt-5">
                <div class="container">
                    <h5 class="display-5 fw-bold text-start">About Us</h5>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <h3 class="display-5 fw-bold text-center">PyLearn</h3>
                <p class="mt-4">
                    PyLearn merupakan sebuah website yang berisi pembahasan mengenai bahasa pemrograman Python. Tak hanya itu saja, pada website ini, juga tersedia informasi berbagai event mengenai
                    Python, misalnya lomba yang berbasis Python. Python sendiri adalah Bahasa pemograman interpretative yang dapat digunakan di berbagai macam platform. Python telah menjadi salah satu
                    Bahasa pemograman paling popular di dunia beberapa tahun terakhir. Python juga dapat digunakan oleh seorang developer maupun non-developer.
                </p>

                <p class="mt-4">
                    PyLearn diharapkan dapat memudahkan dalam mempelajari dan menambah wawasan seputar Python. Mudah-mudahan dengan adanya website pylearn ini kami bisa memberi banyak manfaat.
                </p>

                <p class="mt-4 text-center">
                    <strong>Co-Authors</strong><br />
                    Adisti Khairunnisa Nuzli | Anthonia Audisheren | Ardhi Yahya | Karta Kusuma | Wahyu Adhi Prabowo
                </p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path
        ...
        <section class="mycolor-second">
            <div class="container">
                ...
                <form action="about.php" method="post" name="langganan">
